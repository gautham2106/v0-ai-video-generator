...
export function ResultsSection({ videoUrl, images, onGenerateAnother }: ResultsSectionProps) {
    ...
    <div className="space-y-6">
      ...
      <Card className="overflow-hidden">
        <div className="aspect-video bg-secondary flex items-center justify-center">
          <img src={videoUrl || "/placeholder.svg"} alt="Generated video" className="w-full h-full object-cover" />
        </div>
      </Card>
      ...
      <Card className="p-6">
        ...
        <div className="space-y-3">
          <div className="flex justify-between text-sm">
            ...
            <span className="text-foreground font-medium">$0.08</span>
          </div>
          <div className="flex justify-between text-sm">
          ...
          <div className="flex justify-between text-sm">
            ...
            <span className="text-foreground font-medium">$1.27</span>
          </div>
          <div className="pt-3 border-t border-border flex justify-between">
            <span className="font-semibold text-foreground">Total</span>
            <span className="font-semibold text-primary text-lg">$1.47</span>
          </div>
        </div>
      </Card>
